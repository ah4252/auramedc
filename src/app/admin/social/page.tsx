                  ...
                  <div className="flex justify-between items-start mb-8">
                     <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-medical-500/20">
                           {selectedUser.image ? <img src={selectedUser.image} alt={selectedUser.name || "صورة الطالب"} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400"><User className="w-8 h-8" /></div>}
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {selectedUser.telegram && (
                      <motion.a 
                        ...
                        href={getSocialUrl(selectedUser.telegram, "telegram")} 
                    ...
                    {selectedUser.instagram && (
                      <motion.a 
                        whileHover={{ scale: 1.01 }}
                        href={getSocialUrl(selectedUser.instagram, "instagram")} 
                        target="_blank" rel="noopener noreferrer"
                    ...
                    {selectedUser.facebook && (
                      <motion.a 
                        whileHover={{ scale: 1.01 }}
                        href={getSocialUrl(selectedUser.facebook, "facebook")} 
                        target="_blank" rel="noopener noreferrer"
