...
import { Settings, Shield, Lock, Palette, Save, AlertTriangle, UserPlus, Globe, Monitor as MonitorIcon, Database, ShieldCheck, Mail, Sliders, Cpu, Users, Stethoscope, PlayCircle, ExternalLink, CheckCircle2 } from "lucide-react";
...
export default function AdminSettingsPage() {
  ...
  const primaryBorderStyle = { borderColor: primaryColor, color: primaryColor };
  const secondaryBgStyle = { backgroundColor: secondaryColor };
  const previewBgStyle = { background: `radial-gradient(circle at 50% 120%, ${primaryColor}20, transparent)` };
              ...
              {activeTab === "general" && (
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="notificationEmail" className="text-sm font-black text-slate-700 dark:text-slate-300">البريد الإلكتروني للإشعارات</label>
                      <input 
                        id="notificationEmail"
                        title="البريد الإلكتروني للإشعارات"
                        placeholder="admin@medgpa.com"
                        type="email" 
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     ...
                     <div className="md:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border-2 border-dashed border-slate-200 dark:border-slate-700 relative overflow-hidden min-h-[300px]">
                        ...
                        <div className="space-y-6 max-w-md mx-auto">
                           ...
                           <div className="w-full bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-lg border border-slate-100 dark:border-slate-700 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                 <Stethoscope className="w-5 h-5" style={primaryColorStyle} />
                              ...
                              <div className="px-3 py-1.5 rounded-lg text-[10px] font-bold text-white shadow-sm" style={primaryBgStyle}>
                                 حاسبة المعدل
                              </div>
                           </div>
                           ...
                           <div className="space-y-4 px-4">
                              ...
                              <div className="w-full h-20 rounded-2xl bg-slate-50 dark:bg-slate-800/50 flex items-center justify-center border border-slate-100 dark:border-slate-700">
                                 <div className="w-12 h-12 rounded-full bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center">
                                    <PlayCircle className="w-6 h-6" style={primaryColorStyle} />
                                 </div>
                              </div>
                              <div className="flex gap-3">
                                 <div className="flex-1 h-10 rounded-xl flex items-center justify-center text-xs font-bold text-white shadow-md transition-transform hover:scale-105" style={primaryBgStyle}>
                                    اشترك الآن
                                 </div>
                                 <div className="flex-1 h-10 rounded-xl border-2 flex items-center justify-center text-xs font-bold" style={primaryBorderStyle}>
                                    تواصل معنا
                                 </div>
                              </div>
                           </div>
                        ...
                        {/* Background effect */}
                        <div className="absolute inset-0 pointer-events-none opacity-50" style={previewBgStyle}></div>
                     </div>
                  </div>
