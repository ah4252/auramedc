...
import { deleteLesson, deleteCategory, deleteSubject } from "@/app/actions/content";
import { useRouter } from "next/navigation";

export default function DeleteButton({ id, type }: { id: string, type: "lesson" | "category" | "subject" }) {
