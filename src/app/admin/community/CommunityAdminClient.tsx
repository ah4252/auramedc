...
export default function CommunityAdminClient({ initialDiscussions, categoryName }: { initialDiscussions: any[], categoryName?: string }) {
                  ...
                  <td className="p-6">
                    <div className="flex items-center gap-2">
                       <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border border-slate-200">
                          {d.user?.image ? <img src={d.user.image} className="w-full h-full object-cover" /> : <User className="w-4 h-4 text-slate-400" />}
                       </div>
