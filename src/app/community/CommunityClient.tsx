...
export default function CommunityClient({ initialDiscussions, subjects, user, categoryName }: { initialDiscussions: any[], subjects: any[], user: any, categoryName?: string }) {
