...
import { LogIn, Mail, Lock, ArrowRight, HeartPulse } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -right-24 w-96 h-96 bg-medical-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 -left-24 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
      </div>
      ...
      >
        <div className="bg-white dark:bg-dark-card rounded-[2.5rem] shadow-2xl shadow-medical-600/10 border border-slate-100 dark:border-slate-800 p-8 md:p-10">
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-slate-500 mt-2">أهلاً بك مجدداً في منصتك التعليمية</p>
          </div>
          ...
          <form action={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center mr-1">
                ...
                <Link href="#" className="text-xs text-medical-600 hover:underline">نسيت كلمة المرور؟</Link>
              </div>
              <div className="relative">
                <input 
                  name="password"
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500 text-sm">
              ليس لديك حساب؟{" "}
              <Link href="/register" className="text-medical-600 font-bold hover:underline">
                إنشاء حساب جديد
              </Link>
            </p>
          </div>
