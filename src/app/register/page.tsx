        ...
        <div className="bg-[#0f172a]/70 backdrop-blur-2xl rounded-[3rem] shadow-[0_0_80px_-20px_rgba(14,165,233,0.25)] border border-white/5 p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <p className="text-slate-400 font-bold">
              {t("register_page_subtitle", "انضم لآلاف الطلاب وابدأ رحلتك التعليمية المتميزة")}
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-black text-slate-300 mr-2">{t("name_label", "الاسم الكامل")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-slate-300 mr-2">{t("study_year_label", "السنة الدراسية")}</label>
              <div className="relative group">
                <input 
                  name="studyYear"
                  type="text"
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-slate-300 mr-2">{t("password_label", "كلمة المرور")}</label>
              <div className="relative group">
                <input 
                  name="password"
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-slate-300 mr-2">{t("confirm_password_label", "تأكيد كلمة المرور")}</label>
              <div className="relative group">
                <input 
